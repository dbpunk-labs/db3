...
goog.exportSymbol('proto.db3_namespace_proto.Namespace', null, global);
goog.exportSymbol('proto.db3_namespace_proto.QueryPrice', null, global);
/**
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.db3_namespace_proto.QueryPrice.displayName = 'proto.db3_namespace_proto.QueryPrice';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.db3_namespace_proto.Namespace.displayName = 'proto.db3_namespace_proto.Namespace';
}
 ...
 * @return {!Object}
 */
proto.db3_namespace_proto.QueryPrice.prototype.toObject = function(opt_includeInstance) {
  return proto.db3_namespace_proto.QueryPrice.toObject(opt_includeInstance, this);
};
 ...
 */
proto.db3_namespace_proto.QueryPrice.toObject = function(includeInstance, msg) {
  var f, obj = {
    price: (f = msg.getPrice()) && db3_base_pb.Price.toObject(includeInstance, f),
...
proto.db3_namespace_proto.QueryPrice.deserializeBinary = function(bytes) {
  ...
  return proto.db3_namespace_proto.QueryPrice.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.db3_namespace_proto.QueryPrice}
 */
proto.db3_namespace_proto.QueryPrice.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value,db3_base_pb.Price.deserializeBinaryFromReader);
      msg.setPrice(value);
      break;
    case 2:
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_namespace_proto.QueryPrice.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPrice();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      db3_base_pb.Price.serializeBinaryToWriter
    );
  }
...
proto.db3_namespace_proto.QueryPrice.prototype.getPrice = function() {
  return /** @type{?proto.db3_base_proto.Price} */ (
    jspb.Message.getWrapperField(this, db3_base_pb.Price, 1));
};
 ...
 * @return {!Object}
 */
proto.db3_namespace_proto.Namespace.prototype.toObject = function(opt_includeInstance) {
  return proto.db3_namespace_proto.Namespace.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_namespace_proto.Namespace.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    price: (f = msg.getPrice()) && proto.db3_namespace_proto.QueryPrice.toObject(includeInstance, f),
    ts: jspb.Message.getFieldWithDefault(msg, 3, 0),
    description: jspb.Message.getFieldWithDefault(msg, 4, ""),
    meta: (f = msg.getMeta()) && db3_base_pb.BroadcastMeta.toObject(includeInstance, f)
  };
...
proto.db3_namespace_proto.Namespace.deserializeBinary = function(bytes) {
  ...
  return proto.db3_namespace_proto.Namespace.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.db3_namespace_proto.Namespace}
 */
proto.db3_namespace_proto.Namespace.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      reader.readMessage(value,proto.db3_namespace_proto.QueryPrice.deserializeBinaryFromReader);
      msg.setPrice(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readUint64());
    ...
    case 5:
      ...
      reader.readMessage(value,db3_base_pb.BroadcastMeta.deserializeBinaryFromReader);
      msg.setMeta(value);
      break;
    default:
      reader.skipField();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_namespace_proto.Namespace.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
...
proto.db3_namespace_proto.Namespace.prototype.getPrice = function() {
  return /** @type{?proto.db3_namespace_proto.QueryPrice} */ (
    jspb.Message.getWrapperField(this, proto.db3_namespace_proto.QueryPrice, 2));
};
...
proto.db3_namespace_proto.Namespace.prototype.getMeta = function() {
  return /** @type{?proto.db3_base_proto.BroadcastMeta} */ (
    jspb.Message.getWrapperField(this, db3_base_pb.BroadcastMeta, 5));
};
