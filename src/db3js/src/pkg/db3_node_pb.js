...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.db3_node_proto.CloseSessionPayload.displayName =
		"proto.db3_node_proto.CloseSessionPayload";
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	 ...
	 * @return {!Object}
	 */
	proto.db3_node_proto.CloseSessionPayload.prototype.toObject = function(
		opt_includeInstance,
	) {
		return proto.db3_node_proto.CloseSessionPayload.toObject(
			opt_includeInstance,
			this,
		);
	};
	 ...
	 * @suppress {unusedLocalVariables} f is only used for nested messages
	 */
	proto.db3_node_proto.CloseSessionPayload.toObject = function(
		includeInstance,
		msg,
	) {
		var f,
...
proto.db3_node_proto.CloseSessionPayload.deserializeBinary = function(bytes) {
	...
	return proto.db3_node_proto.CloseSessionPayload.deserializeBinaryFromReader(
		msg,
		reader,
	);
};
 ...
 * @return {!proto.db3_node_proto.CloseSessionPayload}
 */
proto.db3_node_proto.CloseSessionPayload.deserializeBinaryFromReader = function(
	msg,
	reader,
) {
	while (reader.nextField()) {
...
proto.db3_node_proto.CloseSessionPayload.prototype.serializeBinary = function() {
	var writer = new jspb.BinaryWriter();
	proto.db3_node_proto.CloseSessionPayload.serializeBinaryToWriter(
		this,
		writer,
	);
	return writer.getResultBuffer();
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_node_proto.CloseSessionPayload.serializeBinaryToWriter = function(
	message,
	writer,
) {
	var f = undefined;
 ...
 */
proto.db3_node_proto.CloseSessionPayload.prototype.setSessionInfo = function(
	value,
) {
	return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.db3_node_proto.CloseSessionPayload} returns this
 */
proto.db3_node_proto.CloseSessionPayload.prototype.setSessionToken = function(
	value,
) {
	return jspb.Message.setProto3StringField(this, 2, value);
};
