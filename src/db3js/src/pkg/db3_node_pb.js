...
proto.db3_node_proto.BatchRangeKey = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.db3_node_proto.BatchRangeKey.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.db3_node_proto.BatchRangeKey.displayName = 'proto.db3_node_proto.BatchRangeKey';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.db3_node_proto.BatchRangeKey.prototype.toObject = function(opt_includeInstance) {
  return proto.db3_node_proto.BatchRangeKey.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_node_proto.BatchRangeKey.toObject = function(includeInstance, msg) {
  var f, obj = {
    ns: msg.getNs_asB64(),
    rangeList: jspb.Message.toObjectList(msg.getRangeList(),
    proto.db3_node_proto.Range.toObject, includeInstance),
...
proto.db3_node_proto.BatchRangeKey.deserializeBinary = function(bytes) {
  ...
  return proto.db3_node_proto.BatchRangeKey.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.db3_node_proto.BatchRangeKey}
 */
proto.db3_node_proto.BatchRangeKey.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_node_proto.BatchRangeKey.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
proto.db3_node_proto.BatchRangeKey.prototype.getRangeList = function() {
  return /** @type{!Array<!proto.db3_node_proto.Range>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.db3_node_proto.Range, 2));
};
 ...
 * @return {!proto.db3_node_proto.Range}
 */
proto.db3_node_proto.BatchRangeKey.prototype.addRange = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.db3_node_proto.Range, opt_index);
};
