...
goog.exportSymbol('proto.db3_base_proto.BroadcastMeta', null, global);
goog.exportSymbol('proto.db3_base_proto.ChainId', null, global);
goog.exportSymbol('proto.db3_base_proto.ChainRole', null, global);
goog.exportSymbol('proto.db3_base_proto.Erc20Token', null, global);
goog.exportSymbol('proto.db3_base_proto.Price', null, global);
...
proto.db3_base_proto.Erc20Token = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.db3_base_proto.Erc20Token.repeatedFields_, null);
};
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.db3_base_proto.Erc20Token.displayName = 'proto.db3_base_proto.Erc20Token';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.db3_base_proto.BroadcastMeta.displayName = 'proto.db3_base_proto.BroadcastMeta';
}
 ...
 * @return {!Object}
 */
proto.db3_base_proto.Erc20Token.prototype.toObject = function(opt_includeInstance) {
  return proto.db3_base_proto.Erc20Token.toObject(opt_includeInstance, this);
};
...
proto.db3_base_proto.Erc20Token.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    scalarList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f
  };
...
proto.db3_base_proto.Erc20Token.deserializeBinary = function(bytes) {
  ...
  return proto.db3_base_proto.Erc20Token.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.db3_base_proto.Erc20Token}
 */
proto.db3_base_proto.Erc20Token.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_base_proto.Erc20Token.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSymbal();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!proto.db3_base_proto.Erc20Token} returns this
 */
proto.db3_base_proto.Erc20Token.prototype.addUnits = function(value, opt_index) {
 ...
 * @return {!proto.db3_base_proto.Erc20Token} returns this
 */
proto.db3_base_proto.Erc20Token.prototype.addScalar = function(value, opt_index) {
 ...
 * @return {!Object}
 */
proto.db3_base_proto.Price.prototype.toObject = function(opt_includeInstance) {
...
proto.db3_base_proto.Price.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    token: (f = msg.getToken()) && proto.db3_base_proto.Erc20Token.toObject(includeInstance, f)
  };
...
proto.db3_base_proto.Price.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value,proto.db3_base_proto.Erc20Token.deserializeBinaryFromReader);
      msg.setToken(value);
      break;
    default:
      reader.skipField();
...
proto.db3_base_proto.Price.prototype.getToken = function() {
  return /** @type{?proto.db3_base_proto.Erc20Token} */ (
    jspb.Message.getWrapperField(this, proto.db3_base_proto.Erc20Token, 3));
};
 ...
 * @return {!Object}
 */
proto.db3_base_proto.BroadcastMeta.prototype.toObject = function(opt_includeInstance) {
  return proto.db3_base_proto.BroadcastMeta.toObject(opt_includeInstance, this);
};
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_base_proto.BroadcastMeta.toObject = function(includeInstance, msg) {
  var f, obj = {
...
proto.db3_base_proto.BroadcastMeta.deserializeBinary = function(bytes) {
  ...
  return proto.db3_base_proto.BroadcastMeta.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.db3_base_proto.BroadcastMeta}
 */
proto.db3_base_proto.BroadcastMeta.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.db3_base_proto.BroadcastMeta.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNonce();
  if (f !== 0) {
    writer.writeUint64(
