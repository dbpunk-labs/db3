...
globalThis.__hack = goog.exportSymbol(
	"proto.db3_mutation_proto.Mutation",
	null,
	global,
);
globalThis.__hack = goog.exportSymbol(
...
globalThis.__hack = goog.exportSymbol(
	"proto.db3_mutation_proto.PayloadType",
	null,
	global,
);
globalThis.__hack = goog.exportSymbol(
	"proto.db3_mutation_proto.WriteRequest",
	null,
	global,
);
/**
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.db3_mutation_proto.KVPair.displayName =
		"proto.db3_mutation_proto.KVPair";
}
/**
 * Generated by JsPbCodeGenerator.
...
proto.db3_mutation_proto.Mutation = function(opt_data) {
	jspb.Message.initialize(
		...
		0,
		-1,
		proto.db3_mutation_proto.Mutation.repeatedFields_,
		null,
	);
};
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.db3_mutation_proto.Mutation.displayName =
		"proto.db3_mutation_proto.Mutation";
}
/**
 * Generated by JsPbCodeGenerator.
...
if (goog.DEBUG && !COMPILED) {
	 ...
	 * @override
	 */
	proto.db3_mutation_proto.WriteRequest.displayName =
		"proto.db3_mutation_proto.WriteRequest";
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
	...
	proto.db3_mutation_proto.Mutation.toObject = function(
		...
		var f,
			obj = {
				ns: msg.getNs_asB64(),
				kvPairsList: jspb.Message.toObjectList(
					msg.getKvPairsList(),
					proto.db3_mutation_proto.KVPair.toObject,
					includeInstance,
				),
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 2:
				...
				reader.readMessage(
					value,
					proto.db3_mutation_proto.KVPair.deserializeBinaryFromReader,
				);
...
proto.db3_mutation_proto.Mutation.serializeBinaryToWriter = function(
	...
	if (f != null) {
		writer.writeMessage(6, f, db3_base_pb.Units.serializeBinaryToWriter);
	}
	f = message.getGas();
	if (f !== 0) {
	...
	proto.db3_mutation_proto.WriteRequest.toObject = function(
		...
		var f,
			obj = {
				...
				payloadType: jspb.Message.getFieldWithDefault(msg, 4, 0),
			};
	...
	while (reader.nextField()) {
		...
		switch (field) {
			...
			case 3:
				...
				break;
			case 4:
				var value = /** @type {!proto.db3_mutation_proto.PayloadType} */ (reader.readEnum());
 ...
 * @return {string}
 */
proto.db3_mutation_proto.WriteRequest.prototype.getPayload = function() {
	return /** @type {string} */ (jspb.Message.getFieldWithDefault(
		this,
		2,
		"",
 ...
 * @return {string}
 */
proto.db3_mutation_proto.WriteRequest.prototype.getPayload_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.db3_mutation_proto.WriteRequest.prototype.getPayload_asU8 = function() {
	return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
		this.getPayload(),
	));
};
 ...
 * @return {!proto.db3_mutation_proto.WriteRequest} returns this
 */
proto.db3_mutation_proto.WriteRequest.prototype.setPayload = function(value) {
	return jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!proto.db3_mutation_proto.PayloadType}
 */
proto.db3_mutation_proto.WriteRequest.prototype.getPayloadType = function() {
	return /** @type {!proto.db3_mutation_proto.PayloadType} */ (jspb.Message.getFieldWithDefault(
		this,
		4,
		0,
	));
...
/**
 * @param {!proto.db3_mutation_proto.PayloadType} value
 * @return {!proto.db3_mutation_proto.WriteRequest} returns this
 */
proto.db3_mutation_proto.WriteRequest.prototype.setPayloadType = function(
	value,
) {
	return jspb.Message.setProto3EnumField(this, 4, value);
};
