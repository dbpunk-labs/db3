...
goog.exportSymbol('proto.db3_mutation_proto.PayloadType', null, global);
...
proto.db3_mutation_proto.WriteRequest.prototype.getPayloadType = function() {
  return /** @type {!proto.db3_mutation_proto.PayloadType} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.db3_mutation_proto.WriteRequest} returns this
 */
proto.db3_mutation_proto.WriteRequest.prototype.setPayloadType = function(value) {
  return jspb.Message.setProto3EnumField(this, 4, value);
};
