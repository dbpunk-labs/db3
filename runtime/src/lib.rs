...
pub use db3_primitives::{AccountId, Signature};
use db3_primitives::{AccountIndex, Balance, BlockNumber, Hash, Index, Moment};
...
impl pallet_sql_db::Config for Runtime {
    type AuthorityId = pallet_sql_db::crypto::TestAuthId;
    type Event = Event;
    type Currency = Balances;
    type Call = Call;
    type FeeDestination = ();
    type WeightInfo = pallet_sql_db::weights::SubstrateWeight<Runtime>;
    type MaxBlockTransactions = ConstU32<{ pallet_sql_db::DEFAULT_MAX_BLOCK_TRANSACTIONS }>;
    type MaxTransactionSize = ConstU32<{ pallet_sql_db::DEFAULT_MAX_TRANSACTION_SIZE }>;
}
...
construct_runtime!(
    pub enum Runtime where
        Block = Block,
        NodeBlock = db3_primitives::Block,
